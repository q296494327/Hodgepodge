 ...
 * Desc: 短篇鬼故事fragment
 */
public class MingJianGhostFragment extends BaseGhostFragment implements XListView
        .IXListViewListener,
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            mGhostCategoryBean = mProtocol.loadData("mj", page);
        ...
        public void run() {
            ...
            try {
                ...
                final List<GhostCategoryBean.ShowapiResBodyEntity.PagebeanEntity
                        ...
                        .loadData("mj", page).showapi_res_body.pagebean.contentlist;
                LogUtils.sf("下拉刷新中");
