 ...
 * Desc: 校花美女
 */
public class XiaoQingXinFragment extends BaseBeautyFragment implements SHSwipeRefreshLayout
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            mBaiduBeautyBean = mProtocol.loadData("美女", "小清新", 0);
        ...
        public void run() {
            ...
            try {
                ...
                final List<BaiduBeautyBean.BaiduBeautyData>
                        baiduBeautyDatas = mProtocol.loadData("美女", "小清新", index * 20).data;
                LogUtils.sf("下拉刷新中");
