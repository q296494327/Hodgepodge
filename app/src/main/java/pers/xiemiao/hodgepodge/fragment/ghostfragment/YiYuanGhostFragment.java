 ...
 * Desc: 短篇鬼故事fragment
 */
public class YiYuanGhostFragment extends BaseGhostFragment implements XListView
        .IXListViewListener,
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            mGhostCategoryBean = mProtocol.loadData("yy", page);
        ...
        public void run() {
            ...
            try {
                ...
                final List<GhostCategoryBean.ShowapiResBodyEntity.PagebeanEntity
                        ...
                        .loadData("yy", page).showapi_res_body.pagebean.contentlist;
                LogUtils.sf("下拉刷新中");
