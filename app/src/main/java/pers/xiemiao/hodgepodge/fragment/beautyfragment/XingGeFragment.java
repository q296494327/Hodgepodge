 ...
 * Desc: 性格美女
 */
public class XingGeFragment extends BaseBeautyFragment implements PullToRefreshLayout
        .OnPullListener {
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            GirlCategoryBean girlCategoryBean = mProtocol.loadData("xingge");
        ...
        public void run() {
            ...
            try {
                final List<GirlCategoryBean.ShowapiResBodyEntity.PagebeanEntity.GirlCategoryData>
                        girlCategoryDatas = mProtocol.loadData("xingge").showapi_res_body
                        .pagebean
                        .contentlist;
                LogUtils.sf("下拉刷新中");
