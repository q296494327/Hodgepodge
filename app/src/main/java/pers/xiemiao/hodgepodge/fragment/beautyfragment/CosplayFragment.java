 ...
 * Desc: 校花美女
 */
public class CosplayFragment extends BaseBeautyFragment implements SHSwipeRefreshLayout
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            mBaiduBeautyBean = mProtocol.loadData("美女", "cosplay", 0);
        ...
        public void run() {
            ...
            try {
                ...
                final List<BaiduBeautyBean.BaiduBeautyData>
                        baiduBeautyDatas = mProtocol.loadData("美女", "cosplay", index * 20).data;
                LogUtils.sf("下拉刷新中");
