 ...
 * Desc: 模特美女
 */
public class MoteFragment extends BaseBeautyFragment implements PullToRefreshLayout
        .OnPullListener {
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            GirlCategoryBean girlCategoryBean = mProtocol.loadData("mote");
        ...
        public void run() {
            ...
            try {
                final List<GirlCategoryBean.ShowapiResBodyEntity.PagebeanEntity.GirlCategoryData>
                        girlCategoryDatas = mProtocol.loadData("mote").showapi_res_body
                        .pagebean
                        .contentlist;
                LogUtils.sf("下拉刷新中");
