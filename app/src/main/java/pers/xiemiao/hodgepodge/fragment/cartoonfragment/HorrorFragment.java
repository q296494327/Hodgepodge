 ...
 * Desc: 恐怖漫画fragment
 */
public class HorrorFragment extends BaseCartoonFragment implements AdapterView
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            CartoonCategoryBean cartoonCategoryBean = mProtocol.loadData("weimanhua/kbmh", 1);
        ...
        public void run() {
            ...
            try {
                final List<CartoonCategoryBean.ShowapiResBodyEntity.PagebeanEntity
                        ...
                        ("weimanhua/kbmh", 1).showapi_res_body.pagebean.contentlist;
                LogUtils.sf("下拉刷新中");
        ...
        public void run() {
            ...
            try {
                final List<CartoonCategoryBean.ShowapiResBodyEntity.PagebeanEntity
                        ...
                        .loadData("weimanhua/kbmh", mDatas.size() / 50 + 1).showapi_res_body
