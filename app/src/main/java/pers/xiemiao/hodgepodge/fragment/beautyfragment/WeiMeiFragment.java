 ...
 * Desc: 校花美女
 */
public class WeiMeiFragment extends BaseBeautyFragment implements SHSwipeRefreshLayout
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            mBaiduBeautyBean = mProtocol.loadData("美女", "唯美", 0);
        ...
        public void run() {
            ...
            try {
                ...
                final List<BaiduBeautyBean.BaiduBeautyData>
                        baiduBeautyDatas = mProtocol.loadData("美女", "唯美", index * 20).data;
                LogUtils.sf("下拉刷新中");
