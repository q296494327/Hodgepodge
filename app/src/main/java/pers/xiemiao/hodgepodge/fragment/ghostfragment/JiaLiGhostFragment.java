 ...
 * Desc: 短篇鬼故事fragment
 */
public class JiaLiGhostFragment extends BaseGhostFragment implements XListView
        .IXListViewListener,
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            mGhostCategoryBean = mProtocol.loadData("jl", page);
        ...
        public void run() {
            ...
            try {
                ...
                final List<GhostCategoryBean.ShowapiResBodyEntity.PagebeanEntity
                        ...
                        .loadData("jl", page).showapi_res_body.pagebean.contentlist;
                LogUtils.sf("下拉刷新中");
