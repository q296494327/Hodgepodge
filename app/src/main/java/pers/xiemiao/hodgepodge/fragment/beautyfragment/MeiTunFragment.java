 ...
 * Desc: 美女tun
 */
public class MeiTunFragment extends BaseBeautyFragment implements PullToRefreshLayout
        .OnPullListener {
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            GirlCategoryBean girlCategoryBean = mProtocol.loadData("meitun");
        ...
        public void run() {
            ...
            try {
                final List<GirlCategoryBean.ShowapiResBodyEntity.PagebeanEntity.GirlCategoryData>
                        girlCategoryDatas = mProtocol.loadData("meitun").showapi_res_body
                        .pagebean
                        .contentlist;
                LogUtils.sf("下拉刷新中");
