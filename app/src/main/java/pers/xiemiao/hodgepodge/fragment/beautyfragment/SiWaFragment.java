 ...
 * Desc: 丝袜
 */
public class SiWaFragment extends BaseBeautyFragment implements PullToRefreshLayout
        .OnPullListener {
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            GirlCategoryBean girlCategoryBean = mProtocol.loadData("siwa");
        ...
        public void run() {
            ...
            try {
                final List<GirlCategoryBean.ShowapiResBodyEntity.PagebeanEntity.GirlCategoryData>
                        girlCategoryDatas = mProtocol.loadData("siwa").showapi_res_body
                        .pagebean
                        .contentlist;
                LogUtils.sf("下拉刷新中");
