 ...
 * Desc:故事漫画fragment
 */
public class StoryFragment extends BaseCartoonFragment implements AdapterView
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            CartoonCategoryBean cartoonCategoryBean = mProtocol.loadData("weimanhua/gushimanhua", 1);
        ...
        public void run() {
            ...
            try {
                final List<CartoonCategoryBean.ShowapiResBodyEntity.PagebeanEntity
                        ...
                        ("weimanhua/gushimanhua", 1).showapi_res_body.pagebean.contentlist;
                LogUtils.sf("下拉刷新中");
        ...
        public void run() {
            ...
            try {
                final List<CartoonCategoryBean.ShowapiResBodyEntity.PagebeanEntity
                        ...
                        .loadData("weimanhua/gushimanhua", mDatas.size() / 50 + 1).showapi_res_body
