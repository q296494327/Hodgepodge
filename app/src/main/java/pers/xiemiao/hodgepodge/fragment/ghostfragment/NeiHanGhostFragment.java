 ...
 * Desc: 短篇鬼故事fragment
 */
public class NeiHanGhostFragment extends BaseGhostFragment implements XListView
        .IXListViewListener,
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            mGhostCategoryBean = mProtocol.loadData("neihanguigushi", page);
        ...
        public void run() {
            ...
            try {
                ...
                final List<GhostCategoryBean.ShowapiResBodyEntity.PagebeanEntity
                        ...
                        .loadData("neihanguigushi", page).showapi_res_body.pagebean.contentlist;
                LogUtils.sf("下拉刷新中");
