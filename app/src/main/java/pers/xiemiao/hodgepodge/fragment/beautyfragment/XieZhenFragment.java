 ...
 * Desc: 写真艺术
 */
public class XieZhenFragment extends BaseBeautyFragment implements PullToRefreshLayout
        .OnPullListener {
    ...
    public LoaddingPager.LoadResult initData() {
        try {
            ...
            GirlCategoryBean girlCategoryBean = mProtocol.loadData("nvyou");
        ...
        public void run() {
            ...
            try {
                final List<GirlCategoryBean.ShowapiResBodyEntity.PagebeanEntity.GirlCategoryData>
                        girlCategoryDatas = mProtocol.loadData("nvyou").showapi_res_body
                        .pagebean
                        .contentlist;
                LogUtils.sf("下拉刷新中");
