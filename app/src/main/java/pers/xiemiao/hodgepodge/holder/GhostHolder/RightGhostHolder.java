 ...
 * Desc: 头条新闻holder
 */
public class RightGhostHolder extends BaseHolder<GhostCategoryBean.ShowapiResBodyEntity
    ...
    protected View initHolderView() {
        View view = View.inflate(UIUtils.getContext(), R.layout.item_right_ghost, null);
