...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabSelectedTextSize = 14;//被选中后字体大小
    private int tabSelectedTextColor = 0xFF666666;//被选中后字体颜色
    private int mTabSelectedPosition;//记录标签被选中的索引
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabSelectedTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,
                tabSelectedTextSize, dm);
        /*-------------------将value类型改为sp或dp  end---------------------*/
        ...
        tabTextSize = a.getDimensionPixelSize(R.styleable
                .PagerSlidingTabStrip_pstsTabTextSize, tabTextSize);
        tabSelectedTextSize = a.getDimensionPixelSize(R.styleable
                .PagerSlidingTabStrip_pstsTabSelectedTextSize, tabSelectedTextSize);
        tabSelectedTextColor = a.getColor(R.styleable
                .PagerSlidingTabStrip_pstsTabSelectedTextColor, tabSelectedTextColor);
    ...
    public void notifyDataSetChanged() {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                //根据viewpager的页面位置去设置标签孩子滚动到哪里
                currentPosition = pager.getCurrentItem();
                scrollToChild(currentPosition, 0);

                //当所有控件创建完毕时，使页面被选择项选在初始位置
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            //记录一下页面改变后的position
            mTabSelectedPosition = position;
            //当position改变时，同时调用一下更新样式的方法
            updateTabStyles();
        }
